...
xychart-beta
    ...
    x-axis ["Start", "After DVN", "After PANW", "After DAL #1", "After PFE", "After WHR", "After ET", "After AAL", "After LYFT", "After ET #2", "After EPD", "After HAL"]
    y-axis "P&L ($)" -120 --> 80
    line [0, 72.60, 66.30, 9.60, -50.60, -63.01, -16.90, -67.30, -108.70, -56.68, -83.68, -109.84]
```

```mermaid
xychart-beta
    title "Claude — Individual Trade P&L ($)"
    x-axis ["DVN", "PANW", "DAL #1", "PFE", "WHR", "ET", "AAL", "LYFT", "ET #2", "EPD", "HAL"]
    y-axis "P&L ($)" -80 --> 80
    bar [72.60, -6.30, -56.70, -60.20, -12.41, 46.11, -50.40, -41.40, 52.02, -27.00, -26.16]
```

```mermaid
pie title Claude — Trade Outcomes (11 closed)
    "Wins" : 3
    "Losses" : 8
```
