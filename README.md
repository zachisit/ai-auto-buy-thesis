...
| Open / pending | NCLH #2 open from 6/12 at $19.44 (51 shares, stop **$19.75 GTC** (trailed from $19.25), target **$22.00 GTC**, R/R 1:1.68, +**$47.94** unrealized premarket 6/22). Deal implemented — Strait reopening, oil $72. **Portfolio net: -$29.74** | No open positions. **Portfolio net: -$54.62** |
